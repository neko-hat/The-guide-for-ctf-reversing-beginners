...
| nop | nop | 아무것도 하지 않음 |
| cmp | cmp OPERAND1, OPERAND2 | OPERAND1, OPERAND2을 값의 차로 비교.
결과값 저장됨.
값이 같으면 ZF 1로 세팅 |
| test | test OPERAND1, OPERAND2 | OPERAND1, OPERAND2을 bit and 연산을 이용해 비교.
결과값 저장 안됨.
...
| pop | pop OPERAND | OPERAND에 스택의 값을 가져오고 대입.
...
| div | div OPERAND1, OPERAND2 | OPERAND1 / OPERAND2 결과값을 OPERAND1에 저장(몫).
